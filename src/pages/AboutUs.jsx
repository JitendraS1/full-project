  ...
  return (
    <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gray-50 p-4 rounded-lg shadow-sm">
                    <div className="flex items-center mb-1">
                      <h1 className="text-5xl font-bold text-blue-600">5000</h1>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg shadow-sm">
                    <div className="flex items-center mb-1">
                      <h1 className="text-5xl font-bold text-blue-600">40</h1>
                      <span className="text-blue-500 text-2xl font-bold">+</span>
                    </div>
              ...
              <div className="bg-white p-6 text-center h-full rounded-lg shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                <div className="mb-6">
                  <img 
                    ...
                    src={shivsirimg} 
                    alt="Shivkumar Singh Tomar" 
                  />
                  <h3 className="text-xl font-bold text-gray-800 mt-4">Shivkumar Singh Tomar</h3>
              ...
              <div className="bg-white p-6 text-center h-full rounded-lg shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                <div className="mb-6">
                  <img 
                    className="w-48 h-48 rounded-full mx-auto object-cover mb-4 border-2 border-blue-500 shadow-md" 
                    src={mohansirimg} 
                    alt="Mohan Singh Tomar" 
                  />
                  <h3 className="text-xl font-bold text-gray-800 mt-4">Mohan Singh Tomar</h3>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-800 to-blue-600 text-white relative overflow-hidden">
        <div className="absolute left-0 top-0 h-full w-1/3 bg-blue-400 opacity-10 transform -skew-x-12"></div>
