  ...
  const awards = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1579389083078-4e7018379f7e?q=80&w=2070",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1624969862293-b749659a180b?q=80&w=2070",
    },
    {
      id: 4,
  ...
  const milestones = [
    {
      ...
      description:
        "Established with a vision to become a leading real estate developer in emerging smart cities of India.",
    },
    {
      id: 2,
      year: "2017",
      ...
      description:
        "Acquired 50 acres of prime land in Dholera Special Investment Region for future development.",
    },
    {
      id: 3,
      year: "2018",
      ...
      description:
        "Successfully launched Nestoria Green Valley, our first residential township project in Dholera SIR.",
    },
    {
      id: 4,
      year: "2019",
      ...
      description:
        "Began development of Nestoria Business Hub, marking our entry into commercial real estate sector.",
    },
    {
      id: 5,
      year: "2020",
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="relative flex flex-col items-center">
            ...
            {milestones.map((milestone, index) => (
              ...
              >
                <div
                  className={`flex flex-col items-center w-full md:w-2/3 lg:w-1/2 ${
                    index % 2 === 0 ? "md:items-end" : "md:items-start"
                  }`}
                >
                  <div className="flex items-center mb-3">
                    <div className="flex items-center justify-center w-10 h-10 rounded-full bg-blue-600 text-white shadow-lg mr-4">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12">
            <div className="text-center">
              ...
              <a
                href="mailto:media@nestoriagroup.com"
