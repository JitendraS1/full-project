      ...
      <section className="py-16 bg-gray-900 text-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6">
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold mb-2">50000<span className="text-blue-300">+</span></div>
              <p className="text-xl">Visitors</p>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold mb-2">5000<span className="text-blue-300">+</span></div>
              <p className="text-xl">Happy Clients</p>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold mb-2">40<span className="text-blue-300">+</span></div>
              <p className="text-xl">Projects </p>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold mb-2">15<span className="text-blue-300">+</span></div>
            ...
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold mb-2">9<span className="text-blue-300">+</span></div>
